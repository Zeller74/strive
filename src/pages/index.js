    ...
    <div>
      ...
      {showForm && (
        <form className={styles.createGroupInput} onSubmit={handleSubmit}>
          ...
          <button className={styles.createButton2} type="submit">Create</button>
        </form>
      )}
    </div>
  );
            ...
            {isSignedIn ? (
              <>
                ...
                <div className={styles.studyGroupContainer}>
                  ...
                  <div>
                    <button className={styles.createButton1} onClick={toggleSearch}>Find Group</button>
                    <CreateGroupForm />
                  </div>
                </div>
              </>
...
const Header = () => {
  ...
  return (
    <header className={styles.header}>
      ...
      <div style={{ marginLeft: 20, float: "left", marginTop: 3, fontWeight:"bold"}}>STRIVE</div>
      {isSignedIn ? (
